...
| PropertyNamespaceUri        | Text     |  ✅\*     |             | Reference to the `Property` if it is in a different `Domain`, e.g. [https://identifier.buildingsmart.org/uri/buildingsmart/ifc/4.3/prop/position](https://identifier.buildingsmart.org/uri/buildingsmart/ifc/4.3/prop/ClearWidth) Not required if you fill the PropertyCode       |
